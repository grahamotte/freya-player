...
Originally tracked advanced dynamic-range preservation in the work split from NATP.

hwo about VREM -- easy ? worth it?

Identified Dolby Vision and HDR10+ as harder metadata-preservation work that should follow ordinary HEVC remuxing.

ok cool makes sense. can you split it into separate cards and include good details and instructions for the next agent,

Initially separated Dolby Vision and HDR10+ into DOVI and HDPL.
...
Combined DOVI and HDPL into the second focused card with one shared dynamic-HDR design, clear fallbacks, and no AV1 scope.
