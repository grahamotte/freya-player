...
- [x] for the lists on tv series and tv season, we should auto scroll to most recently unwatched item, so the user doesn't need to scroll down a long list
...
- [x] give the watched control button a yellow hue like the progress and check circle has to tie the themes together
